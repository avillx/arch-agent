...
func NewLLMService(repo LLMSettingsRepo, factories ...LLMFactory) (*LLMService, error) {
...
func (s *LLMService) SetLLMSettings(id LLMID, settings LLMSettings) error {
...
func (s *LLMService) GetLLM(id LLMID) (LLM, error) {
	llm, ok := s.llms[id]
	if !ok {
...
func (s *LLMService) AddNewLLM(id LLMID, settings LLMSettings) error {
...
func (s *LLMService) createLLM(id LLMID, settings LLMSettings) error {
...
func (s *LLMService) DeleteLLM(id LLMID) error {
